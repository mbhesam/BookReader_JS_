  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated(changedProps) {
        _get(_getPrototypeOf(Mode1UpLit.prototype), "firstUpdated", this).call(this, changedProps);
      ...
      value: function connectedCallback() {
        _get(_getPrototypeOf(Mode1UpLit.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(Mode1UpLit.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
...
let Mode2UpLit = _decorate([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_0__.customElement)('br-mode-2up')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "firstUpdated",
      value: function firstUpdated(changedProps) {
        _get(_getPrototypeOf(Mode2UpLit.prototype), "firstUpdated", this).call(this, changedProps);
        this.htmlDimensionsCacher.updateClientSizes();
        this.smoothZoomer.attach();
      }
    }, {
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(Mode2UpLit.prototype), "connectedCallback", this).call(this);
        this.htmlDimensionsCacher.attachResizeListener();
        this.smoothZoomer.attach();
      }
    }, {
      ...
      value: function disconnectedCallback() {
        this.htmlDimensionsCacher.detachResizeListener();
        this.smoothZoomer.detach();
        _get(_getPrototypeOf(Mode2UpLit.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "updated",
...
let LeafEdges = _decorate([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_0__.customElement)('br-leaf-edges')], function (_initialize2, _LitElement2) {
  ...
  return {
    ...
    d: [{
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(LeafEdges.prototype), "connectedCallback", this).call(this);
      ...
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        _get(_getPrototypeOf(LeafEdges.prototype), "disconnectedCallback", this).call(this);
        this.addEventListener('mouseenter', this.onMouseEnter);
...
BookReader.prototype._createPageContainer = function (index) {
  return new _BookReader_PageContainer_js__WEBPACK_IMPORTED_MODULE_15__.PageContainer(this.book.getPage(index, false), {
